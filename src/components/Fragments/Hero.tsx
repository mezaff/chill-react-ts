      ...
      <div className="w-[320px] md:w-[1280px] flex flex-col justify-end gap-[12px] mb-[40px] md:mb-[80px] relative z-10">
        ...
        <div className="flex flex-row justify-between items-center">
          <div className="flex flex-row gap-[8px] md:gap-[10px]">
            <Button className="border-2 border-white bg-[#3A354161] rounded-full hover:bg-[#192DB7] hover:border-none w-[55px] h-[25px] md:w-[93px] md:h-[45px] text-white text-[12px] md:text-[16px] font-bold">
              Mulai
            </Button>
            <Button className="border-2 border-white bg-[#3A354161] hover:bg-[#22282A] hover:border-none rounded-full w-[120px] h-[25px] md:w-[185px] md:h-[45px] text-white text-[12px] md:text-[16px] font-bold">
              <img
            ...
            <Button className="border-2 border-white bg-[#3A354161] hover:bg-[#22282A] hover:border-none rounded-full w-[30px] h-[25px] md:w-[52px] md:h-[45px] text-white text-[12px] md:text-[16px] font-bold">
              18+
            </Button>
          </div>
          <div>
            <Button className="border-2 border-white bg-[#3A354161] hover:bg-[#22282A] hover:border-none rounded-full p-1 md:p-0.5 w-[25px] h-[25px] md:w-[45px] md:h-[45px]">
